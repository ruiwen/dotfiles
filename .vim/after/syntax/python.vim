...
syn region pythonFunctionCall start="\v\w+\(" end="\v\)" contains=pythonKwargs,pythonKwargsAssignment,pythonString,pythonConstant,pythonList,pythonDict,pythonStatement fold transparent
